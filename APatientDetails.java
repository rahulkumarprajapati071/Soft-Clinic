...
public class APatientDetails {
	...
	public void viewDetails()
	{
		...
		scrollPane.setBounds(10, 363, 1254, 327);
		...
		JLabel lblNewLabel_3_3_2_2 = new JLabel("CLEAR");
		...
		lblNewLabel_3_3_2_2.setBounds(1135, 114, 152, 39);
		...
		try 
		{
			statement = (PreparedStatement)
					adminLoginConnection.prepareStatement("select * from patientdetails");
